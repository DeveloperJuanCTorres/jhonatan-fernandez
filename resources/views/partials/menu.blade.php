    ...
    <div class="row py-3 border-bottom px-4">
        ...
        <div class="col-lg-8">
            <ul class="pt-2 navbar-nav list-unstyled d-flex flex-row gap-3 gap-lg-5 justify-content-center flex-wrap align-items-center mb-0 fw-bold text-uppercase text-dark">
                <li class="nav-item">
                    <a href="{{ route('home') }}"
                    class="nav-link {{ Route::is('home') ? 'active-menu' : '' }}">
                        Inicio
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('tienda') }}"
                    class="nav-link {{ Route::is('tienda') ? 'active-menu' : '' }}">
                        Tienda
                    </a>
                </li>
                ...
                <li class="nav-item">
                    ...
                    class="nav-link {{ Route::is('contacto') ? 'active-menu' : '' }}">
                        Contactos
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a href="{{ route('blog') }}"
                    class="nav-link {{ Route::is('blog*') ? 'active-menu' : '' }}">
                        Blog
                    </a>
                </li>
            </ul>
